export default [
  ...
  {
    subtitle: 'Makinox-tools',
    description: 'exp.sub1',
    ref: 'https://github.com/makinox/tools',
  ...
  },
  {
    subtitle: 'Shopping',
    description: 'exp.sub1',
    ref: 'https://64a45033f689af007bedfc33--flourishing-mermaid-2850c7.netlify.app/',
  ...
  },
  {
    subtitle: 'Random',
    description: 'exp.sub1',
    ref: 'https://random.jesusbossa.dev/',
  ...
  {
    subtitle: 'Workshop: Data analysis, Server components',
    description: 'exp.sub1',
    ref: 'https://data-workshop.jesusbossa.dev/',
