  ...
  const data: ProjectImagesQuery = useStaticQuery(
    graphql`
      query ProjectImages {
        ...
        img27: file(relativePath: { eq: "projects/projects-img27.png" }) {
          childImageSharp {
            gatsbyImageData(width: 330, height: 200, placeholder: BLURRED, formats: [AUTO, WEBP, AVIF], transformOptions: { fit: COVER })
          }
        }
        img28: file(relativePath: { eq: "projects/projects-img28.png" }) {
          childImageSharp {
            gatsbyImageData(width: 330, height: 200, placeholder: BLURRED, formats: [AUTO, WEBP, AVIF], transformOptions: { fit: COVER })
          }
        }
        img29: file(relativePath: { eq: "projects/projects-img29.png" }) {
          childImageSharp {
            gatsbyImageData(width: 330, height: 200, placeholder: BLURRED, formats: [AUTO, WEBP, AVIF], transformOptions: { fit: COVER })
          }
        }
